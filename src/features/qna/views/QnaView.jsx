...
export default function QnaView() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-5rem)] max-w-4xl mx-auto p-2 sm:p-4">
      {/* HEADER BAR QnA */}
      <div className="flex items-center justify-between p-3 sm:p-4 bg-card border border-border rounded-2xl shadow-xs mb-3">
        <div className="flex items-center gap-3">
          <div className="size-10 rounded-2xl bg-blue-600/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 flex items-center justify-center shadow-xs">
      ...
      <div className="flex-1 overflow-y-auto px-1 py-2 space-y-1 scrollbar-thin scrollbar-thumb-border">
        {messages.map((msg) => (
        ...
        {errorText && (
          <div className="flex items-center gap-2 text-xs text-red-600 dark:text-red-400 bg-red-500/10 border border-red-500/20 p-3 rounded-2xl my-2">
      ...
      {/* FOOTER CHAT INPUT */}
      <div className="sticky bottom-0 pt-2 bg-background/80 backdrop-blur-md">
