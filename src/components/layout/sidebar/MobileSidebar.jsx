...
export default function MobileSidebar({ user, pendingCount = 0 }) {
  ...
  return (
    <Sheet>
      ...
      <SheetContent
        side="left"
        className="flex w-72 flex-col p-0 bg-primary-foreground text-primary transition-all duration-300 ease-in-out"
      >
          ...
          <SheetTitle asChild>
            <Link href="/dashboard" className="flex items-center gap-3">
              ...
              <div className="flex flex-col leading-none text-left">
                <h2 className="font-bold tracking-tight text-primary text-xl">
                  Montir<span className="text-secondary">Go</span>
                </h2>
                <p className="text-[11px] font-medium mt-0.5">Mechanic Suite</p>
              </div>
            </Link>
          </SheetTitle>
        </SheetHeader>
